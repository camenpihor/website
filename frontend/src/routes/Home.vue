<template>
  <section class="home">
    ...
    <div class="home__text">
      <div class="section">
        <h1 class="title is-2 has-text-centered is-relative">
          Hai! I'm Camen :)
        </h1>
        ...
        <div class="subsection">
          ...
          <div class="content">
            <p>
              ...
              taking some time to amble. My roaming is currently taking me to
              the stars, trees, birds, and the clouds, but I'm not too sure
              where I'll end up. I like to think that I am a good Bayesian and
              scientist, but I also like seeking wonder which makes me want to
              talk about the world in different ways.
            </p>
            <p>
      ...
      <div class="section">
        ...
        <ul
          class="subsection has-text-centered"
    ...
    <img class="person-sitting" :src="personSittingFilePath" />
  </section>
</template>
